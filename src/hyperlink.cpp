...
// suppress size warnings... they _are_ taken care of, but because the PlatformSDK is
// leim and define-macro based, the 32bit build environment doesn't realize this.
